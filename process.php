...
$mail->CharSet = 'UTF-8';
$mail->SMTPDebug = 3;
$mail->setFrom('noreply@dirnovo.com', 'Microweb  importadora del Rey');
$mail->Sender='novotecn@gator3249.hostgator.com';
$mail->addAddress('fernando@importadoradelrey.com.py'); // Esta línea, corresponde al mail del cliente
